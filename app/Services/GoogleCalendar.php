...
class GoogleCalendar {
	...
	function __construct() {
		...
		$this->client->setApplicationName("TinyPmt");
	...
	public function get_time_available($calendarId)
	{
		$events = $this->service->events->listEvents($calendarId, ["timeMin" => date("c"), "singleEvents" =>true, "orderBy" => "startTime"]);
